...
"./ripe_attack_generator -t direct -i createfile -c baseptr  -l stack -f strncpy " \
...
"./ripe_attack_generator -t indirect -i createfile -c baseptr  -l stack -f strncpy " \
...
"./ripe_attack_generator -t indirect -i createfile -c baseptr  -l heap -f strncpy " \
...
"./ripe_attack_generator -t indirect -i createfile -c baseptr  -l bss -f strncpy " \
...
"./ripe_attack_generator -t indirect -i createfile -c baseptr  -l data -f strncpy " \
...
"./ripe_attack_generator -t direct -i returnintolibc -c baseptr  -l stack -f strncpy " \
...
"./ripe_attack_generator -t indirect -i returnintolibc -c baseptr  -l stack -f strncpy " \
"./ripe_attack_generator -t indirect -i returnintolibc -c baseptr  -l bss -f strncpy " \
"./ripe_attack_generator -t indirect -i returnintolibc -c baseptr  -l data -f strncpy " \
...
for test in "$@"; do
  ...
  cd ../run_test_dfi
  sleep 1s
  ./test | tee -a ../run_ripe_dfi/log_ripe_${i}
  cd ../run_ripe_dfi
  export i="$(($i+1))"
done
