...
sfunc={'dfi_rocc_stlddebug':'','init_ori_dfi':'','dfi_rocc_debug':'','init_roccinstr_dfi':'','dfi_func_signal':'','init_soft_dfi':'','init_noinstrument_dfi':'','dfi_delay':'','execute_dficheck':'','init_2core_noic_dfi':'','dfi_send_sl':'','dfi_send_lib':'','init_2core_dfi':'','init_pim_dfi':'','init_lite_pim_dfi':'','init_lite_hbm_dfi':'','init_soft_pim_dfi':'','init_soft_hbm_dfi':'','pim_dfi_timestamp':'','pim_dfi_end_timestamp':'','dfi_debug':'','pim_dfi_func_signal':'','pim_dfi_print':''}
...
def inst_ll(idinst,ll_name,ll_out_name):
	...
	if exp_mode=='core2' or exp_mode=='soft' or exp_mode=='softtest' or exp_mode=='roccinstr' or exp_mode=='ori':
...
elif (exp_mode=='noinstr' and mode==2) or exp_mode=='core2' or exp_mode=='roccinstr' or exp_mode=='soft' or exp_mode=='softtest' or exp_mode=='ori':
