...
for i in range(len(inst)):
    if inst[i][0] == 'JUMP':
        ...
        tmp = funcDic['FIFO_INPUT'] | (int(inst[i][1])<<6) | (int(inst[i][2])<<7) 
        inst_bin.append(tmp)

    elif inst[i][0] == 'LOAD':
        tmp = funcDic['LOAD'] | (int(inst[i][1][3:])<<6) | (int(inst[i][2][3:])<<12) | (int(inst[i][3][3:])<<18) | (int(inst[i][4])<<24) | (int(inst[i][5])<<26) | (int(inst[i][6][-1])<<27) 
        inst_bin.append(tmp)

    elif inst[i][0] == 'STORE':
        tmp = funcDic['STORE'] | (int(inst[i][1][3:])<<6) | (int(inst[i][2][3:])<<12) |(int(inst[i][3][3:])<<18)|(int(inst[i][4])<<24)| (int(inst[i][5])<<26) | (int(inst[i][6][-1])<<27)
        inst_bin.append(tmp)
        ...
        tmp = funcDic['R_FIFO'] | (int(inst[i][1][3:])<<6) 
        inst_bin.append(tmp)
        ...
        tmp = funcDic['R_FIFO'] | (hex_tmp<<6) | 1<<63
        inst_bin.append(tmp)
        ...
        tmp = funcDic['IF'] | (int(inst[i][1][3:])<<6) | (int(inst[i][2])<<12) | (int(inst[i][3])<<18)
        inst_bin.append(tmp)
        ...
        tmp = funcDic['SEARCH'] | (int(inst[i][1][3:])<<6) | (int(inst[i][2][3:])<<12) | (int(inst[i][3][3:])<<18) | (int(inst[i][4])<<24)
        inst_bin.append(tmp)
